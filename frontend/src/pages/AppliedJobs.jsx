  ...
  useEffect(() => {
    const fetchAppliedJobs = async () => {
      try {
        ...
        const interviewResponse = await api.get(`/interview/user/${userId}`);
        ...
        const jobDetailsPromises = interviewResponse.data.map(async (interview) => {
          ...
          const jobResponse = await api.get(`/jobs/${interview.jobId}`);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            It seems like you haven't applied for any jobs yet. Start exploring and apply for jobs to see them here.
          </p>
          <Link
            to="/jobs"
              ...
              >
                <div className="px-6 py-4">
                  ...
                  <div className="flex justify-end">
                    ...
                    {job.status === 'completed' && (
                      <Link
                        to={`/interview/report/${job.interviewId}`}
